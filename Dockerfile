...
# ------------------------------------------------------------------
    ...
    $PIP_INSTALL \
        ...
        https://download.pytorch.org/whl/nightly/cu115/torch_nightly.html \
        && \
...
## Others
RUN python -m pip --no-cache-dir install --upgrade openpyxl seaborn dask[complete] chart-studio umap-learn torchsummary
